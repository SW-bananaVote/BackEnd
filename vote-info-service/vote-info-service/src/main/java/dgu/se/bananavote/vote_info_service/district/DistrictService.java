...
public class DistrictService {
    ...
    public boolean existsBySdNameAndWiwNameAndSggName(String sdName, String wiwName, String sggName) {
        return districtRepository.existsBySdNameAndWiwNameAndSggName(sdName, wiwName, sggName);
    }
}
